...
public class Alexa2Ev3DynamoDBClient {
    ...
    private Alexa2Ev3DynamoDBClient(String awsAccessKeyId, String awsSecretAccessKey) {
    ...
    public static synchronized Alexa2Ev3DynamoDBClient getInstance() {
        if (instance == null) {
            instance = new Alexa2Ev3DynamoDBClient(System.getenv("aws_iot_accessKeyId"),
                    System.getenv("aws_iot_secretAccessKey"));
        }
        return instance;
    }
